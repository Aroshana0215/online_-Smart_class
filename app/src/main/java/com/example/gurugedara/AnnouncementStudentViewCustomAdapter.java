...
public class AnnouncementStudentViewCustomAdapter extends RecyclerView.Adapter<AnnouncementStudentViewCustomAdapter.MyViewHolder> {

    private Context context ;
    Activity activity ;
    private ArrayList announcement_id  , announcement_topic , announcement_content;

    AnnouncementStudentViewCustomAdapter(Activity activity , Context context , ArrayList announcement_id , ArrayList announcement_topic , ArrayList announcement_content){
